            ...
            if self.valid():
                ...
                if self.round%2 == 0:
                    ...
                    for i in range(len(self.hand0)):
                        ...
                        if self.hand0[i][0] == self.edges[0]:
                            # Substitui a borda antiga pela nova
                            self.edges[0] = self.hand0[i][1]
                            # Adiciona a nova peça no campo
                            self.field.append(self.hand0[i])
                            ...
                            break
                        # Verifica se alguma peça bate com a borda esquerda
                        if self.hand0[i][1] == self.edges[0]:
                            # Substitui a borda antiga pela nova
                            self.edges[0] = self.hand0[i][0]
                            # Adiciona a nova peça no campo
                            self.field.append(self.hand0[i])
                            # Remove a peça da mão
                            del self.hand0[i]
                        ...
                        if self.hand0[i][0] == self.edges[1]:
                            # Substitui a borda antiga pela nova
                            self.edges[1] = self.hand0[i][1]
                            # Adiciona a nova peça no campo
                            self.field.append(self.hand0[i])
                            # Remove a peça da mão
                            del self.hand0[i]
                            ...
                            break
                        # Verifica se alguma peça bate com a borda direita
                        if self.hand0[i][1] == self.edges[1]:
                            # Substitui a borda antiga pela nova
                            self.edges[1] = self.hand0[i][0]
                            # Adiciona a nova peça no campo
                            self.field.append(self.hand0[i])
                            # Remove a peça da mão
                            del self.hand0[i]
